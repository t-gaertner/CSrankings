...
class CSRankings{constructor(){this.note={};this.authorFile="./csrankings.csv";this.authorinfoFile="./generated-author-info.csv";this.countryinfoFile="./country-info.csv";this.turingFile="./turing.csv";this.turingImage="./png/acm-turing-award.png";this.acmfellowFile="./acm-fellows.csv";this.acmfellowImage="./png/acm.png";this.homepageImage="./png/house-logo.png";this.allowRankingChange=!1;this.areaMap=[{area:"ai",title:"AI"},{area:"aaai",title:"AI"},{area:"ijcai",title:"AI"},{area:"aistats",title:"AI"},
{area:"uai",title:"AI"},{area:"vision",title:"Vision"},{area:"cvpr",title:"Vision"},{area:"eccv",title:"Vision"},{area:"iccv",title:"Vision"},{area:"mlmining",title:"ML"},{area:"icml",title:"ML"},{area:"kdd",title:"ML"},{area:"ecml",title:"ML"},{area:"icdm",title:"ML"},{area:"colt",title:"ML"},{area:"nips",title:"ML"},{area:"nlp",title:"NLP"},{area:"acl",title:"NLP"},{area:"emnlp",title:"NLP"},{area:"naacl",title:"NLP"},{area:"ir",title:"Web+IR"},{area:"sigir",title:"Web+IR"},{area:"www",title:"Web+IR"},
{area:"arch",title:"Arch"},{area:"asplos",title:"Arch"},{area:"isca",title:"Arch"},{area:"micro",title:"Arch"},{area:"hpca",title:"Arch"},{area:"comm",title:"Networks"},{area:"sigcomm",title:"Networks"},{area:"nsdi",title:"Networks"},{area:"sec",title:"Security"},{area:"ccs",title:"Security"},{area:"oakland",title:"Security"},{area:"usenixsec",title:"Security"},{area:"ndss",title:"Security"},{area:"pets",title:"Security"},{area:"mod",title:"DB"},{area:"sigmod",title:"DB"},{area:"vldb",title:"DB"},
{area:"icde",title:"DB"},{area:"pods",title:"DB"},{area:"hpc",title:"HPC"},{area:"sc",title:"HPC"},{area:"hpdc",title:"HPC"},{area:"ics",title:"HPC"},{area:"mobile",title:"Mobile"},{area:"mobicom",title:"Mobile"},{area:"mobisys",title:"Mobile"},{area:"sensys",title:"Mobile"},{area:"metrics",title:"Metrics"},{area:"imc",title:"Metrics"},{area:"sigmetrics",title:"Metrics"},{area:"ops",title:"OS"},{area:"sosp",title:"OS"},{area:"osdi",title:"OS"},{area:"fast",title:"OS"},{area:"usenixatc",title:"OS"},
{area:"eurosys",title:"OS"},{area:"pldi",title:"PL"},{area:"popl",title:"PL"},{area:"icfp",title:"PL"},{area:"oopsla",title:"PL"},{area:"plan",title:"PL"},{area:"soft",title:"SE"},{area:"fse",title:"SE"},{area:"icse",title:"SE"},{area:"ase",title:"SE"},{area:"issta",title:"SE"},{area:"act",title:"Theory"},{area:"focs",title:"Theory"},{area:"soda",title:"Theory"},{area:"stoc",title:"Theory"},{area:"crypt",title:"Crypto"},{area:"crypto",title:"Crypto"},{area:"eurocrypt",title:"Crypto"},{area:"log",
title:"Logic"},{area:"cav",title:"Logic"},{area:"lics",title:"Logic"},{area:"graph",title:"Graphics"},{area:"siggraph",title:"Graphics"},{area:"siggraph-asia",title:"Graphics"},{area:"chi",title:"HCI"},{area:"chiconf",title:"HCI"},{area:"ubicomp",title:"HCI"},{area:"uist",title:"HCI"},{area:"robotics",title:"Robotics"},{area:"icra",title:"Robotics"},{area:"iros",title:"Robotics"},{area:"rss",title:"Robotics"},{area:"bio",title:"Comp. Bio"},{area:"ismb",title:"Comp. Bio"},{area:"recomb",title:"Comp. Bio"},
{area:"da",title:"EDA"},{area:"dac",title:"EDA"},{area:"iccad",title:"EDA"},{area:"bed",title:"Embedded"},{area:"emsoft",title:"Embedded"},{area:"rtas",title:"Embedded"},{area:"rtss",title:"Embedded"},{area:"visualization",title:"Visualization"},{area:"vis",title:"Visualization"},{area:"vr",title:"Visualization"},{area:"ecom",title:"ECom"},{area:"ec",title:"ECom"},{area:"wine",title:"ECom"}];this.aiAreas=["ai","vision","mlmining","nlp","ir"];this.systemsAreas="arch comm sec mod da bed hpc mobile metrics ops plan soft".split(" ");
this.theoryAreas=["act","crypt","log"];this.interdisciplinaryAreas="bio graph ecom chi robotics visualization".split(" ");this.areaNames=[];this.fields=[];this.aiFields=[];this.systemsFields=[];this.theoryFields=[];this.otherFields=[];this.areaDict={};this.areaPosition={};this.subareas={};this.scholarInfo={};this.aliases={};this.turing={};this.acmfellow={};this.countryInfo={};this.countryAbbrv={};this.homepages={};this.useDenseRankings=!1;this.authors=[];this.dblpAuthors={};this.authorAreas={};this.stats=
{};this.areaDeptAdjustedCount={};this.areaStringMap={};this.usePieChart=!1;this.RightTriangle="&#9658;";this.DownTriangle="&#9660;";this.BarChartIcon="<img class='closed_chart_icon chart_icon' alt='closed chart' src='png/barchart.png'>";this.OpenBarChartIcon="<img class='open_chart_icon chart_icon' alt='opened chart' src='png/barchart-open.png'>";this.PieChartIcon="<img class='closed_chart_icon chart_icon' alt='closed chart' src='png/piechart.png'>";this.OpenPieChartIcon="<img class='open_chart_icon chart_icon' alt='opened chart' src='png/piechart-open.png'>";
...
"us";m in c&&(q=c[m]);h+="&nbsp;"+`<span onclick="csr.toggleFaculty('${f}');">${m}</span>`+`&nbsp;<img src="/flags/${q}.png">&nbsp;`+`<span class="hovertip" onclick='csr.toggleChart("${f}"); ga("send", "event", "chart", "toggle-department", "toggle ${f} ${$("#charttype").find(":selected").val()} chart");' id='${f+"-chartwidget"}'>`+this.ChartIcon+"</span>";h+="</td>";h+='<td align="right">'+(Math.round(10*n)/10).toFixed(1)+"</td>";h+='<td align="right">'+d[m];h+="</td>";h+="</tr>\n";h+='<tr><td colspan="4"><div class="csr-chart" id="'+
f+'-chart"></div></td></tr>';h+='<tr><td colspan="4"><div style="display:none;" id="'+f+'-faculty">'+b[m]+"</div></td></tr>";a++;f=n}h+="</tbody></table><br /></div></div>\n<br></body></html>"}else h="<h3>Please select at least one area by clicking one or more checkboxes.</h3>";return h}setAllOn(a=!0){for(let c=0;c<CSRankings.areas.length;c++){const d=this.fields[c],b="input[name="+d+"]";a?d in CSRankings.nextTier?$(b).prop("checked",!1):($(b).prop("checked",!0),$(b).prop("disabled",!1)):($(b).prop("checked",
!1),$(b).prop("disabled",!1))}}rank(a=!0){const c=performance.now();var d={},b={};let e={},h={},f={};this.areaDeptAdjustedCount={};const l=parseInt($("#fromyear").find(":selected").text()),g=parseInt($("#toyear").find(":selected").text()),k=String($("#regions").find(":selected").val());var m=this.updateWeights(f);this.buildDepartments(l,g,f,k,b,d,e,h);this.computeStats(d,m,f);d=this.buildDropDown(d,e,h);b=this.buildOutputString(m,this.countryAbbrv,b,d,CSRankings.minToRank);m=performance.now();console.log("Before render: rank took "+
(m-c)+" milliseconds.");document.getElementById("success").innerHTML=b;$("div").scroll(function(){if(this.scrollTop+this.clientHeight>this.scrollHeight-50){const n=CSRankings.updateMinimum(this);n&&$("div").scrollTop(n)}});a?this.navigoRouter.resume():this.navigoRouter.pause();a=this.updatedURL();this.navigoRouter.navigate(a);m=performance.now();console.log("Rank took "+(m-c)+" milliseconds.");return!1}toggleChart(a){const c=document.getElementById(a+"-chart"),d=document.getElementById(a+"-chartwidget");
...
let d=c.split("&");c=d.some(f=>"all"==f);let b=d.some(f=>"none"==f);if(d.some(f=>0<=CSRankings.regions.indexOf(f))){let f=0;d.forEach(l=>{0<=CSRankings.regions.indexOf(l)&&d.splice(f,1);$("#regions").val(l);f+=1})}d.some(f=>"pie"==f)&&$("#charttype").val("pie");if(c)for(var e in CSRankings.topTierAreas){var h="input[name="+e+"]";$(h).prop("checked",!0);e in CSRankings.childMap&&($(h).prop("disabled",!1),CSRankings.childMap[e].forEach(f=>{f in CSRankings.nextTier||$("input[name="+f+"]").prop("checked",
!0)}))}else if(b)CSRankings.clearNonSubsetted();else{CSRankings.clearNonSubsetted();for(h of d)"none"!=h&&""!=h&&(e="input[name="+h+"]",$(e).prop("checked",!0),$(e).prop("disabled",!1),h in CSRankings.childMap&&CSRankings.childMap[h].forEach(f=>{f in CSRankings.nextTier||$("input[name="+f+"]").prop("checked",!0)}))}}static clearNonSubsetted(){for(let a of CSRankings.areas)if(a in CSRankings.childMap){const c=CSRankings.childMap[a];if(!CSRankings.subsetting(c)){const d="input[name="+a+"]";$(d).prop("checked",
!1);$(d).prop("disabled",!1);c.forEach(b=>{$("input[name="+b+"]").prop("checked",!1)})}}}static subsetting(a){let c=[],d=[];a.forEach(h=>{h in CSRankings.nextTier?d.push(h):c.push(h)});let b=0;c.forEach(h=>{$("input[name="+h+"]").prop("checked")&&b++});let e=0;d.forEach(h=>{$("input[name="+h+"]").prop("checked")&&e++});a=0<e&&0!=d.length;return 0<b&&b<c.length||a}addListeners(){["toyear","fromyear","regions","charttype"].forEach(b=>{document.getElementById(b).addEventListener("change",()=>{this.countAuthorAreas();
this.rank()})});for(var a=0;a<CSRankings.areas.length;a++){let b=CSRankings.areas[a];if(!(b in CSRankings.parentMap)){var c=document.getElementById(b+"-widget");c&&c.addEventListener("click",()=>{this.toggleConferences(b)})}}for(a=0;a<this.fields.length;a++){const b="input[name="+this.fields[a]+"]",e=this.fields[a];(c=document.getElementById(this.fields[a]))&&c.addEventListener("click",()=>{let h=!0;if(e in CSRankings.parentMap){h=!1;var f=CSRankings.parentMap[e],l="input[name="+f+"]";let g=0,k=1;
CSRankings.childMap[f].forEach(m=>{const n=$("input[name="+m+"]").prop("checked");g|=n;k=m in CSRankings.nextTier?k&(n?0:1):k&n});$(l).prop("checked",g);g&&!k||$(l).prop("disabled",!1);g&&!k&&$(l).prop("disabled",!0)}else if(f=$(b).prop("checked"),e in CSRankings.childMap)for(l of CSRankings.childMap[e]){const g="input[name="+l+"]";l in CSRankings.nextTier?$(g).prop("checked",!1):$(g).prop("checked",f)}this.rank(h)})}const d={all_areas_on:()=>{this.activateAll()},all_areas_off:()=>{this.activateNone()},
...
CSRankings.topLevelAreas={};CSRankings.topTierAreas={};CSRankings.regions="us europe ca northamerica southamerica australasia asia africa world".split(" ");CSRankings.nameMatcher=RegExp("(.*)\\s+\\[(.*)\\]");CSRankings.parentIndex={};
CSRankings.parentMap={aaai:"ai",ijcai:"ai",aistats:"ai",uai:"ai",cvpr:"vision",eccv:"vision",iccv:"vision",icml:"mlmining",ecml:"mlmining",kdd:"mlmining",icdm:"mlmining",colt:"mlmining",nips:"mlmining",acl:"nlp",emnlp:"nlp",naacl:"nlp",sigir:"ir",www:"ir",asplos:"arch",isca:"arch",micro:"arch",hpca:"arch",ccs:"sec",oakland:"sec",usenixsec:"sec",ndss:"sec",pets:"sec",vldb:"mod",sigmod:"mod",icde:"mod",pods:"mod",dac:"da",iccad:"da",emsoft:"bed",rtas:"bed",rtss:"bed",sc:"hpc",hpdc:"hpc",ics:"hpc",mobicom:"mobile",
mobisys:"mobile",sensys:"mobile",imc:"metrics",sigmetrics:"metrics",osdi:"ops",sosp:"ops",eurosys:"ops",fast:"ops",usenixatc:"ops",popl:"plan",pldi:"plan",oopsla:"plan",icfp:"plan",fse:"soft",icse:"soft",ase:"soft",issta:"soft",nsdi:"comm",sigcomm:"comm",siggraph:"graph","siggraph-asia":"graph",focs:"act",soda:"act",stoc:"act",crypto:"crypt",eurocrypt:"crypt",cav:"log",lics:"log",ismb:"bio",recomb:"bio",ec:"ecom",wine:"ecom",chiconf:"chi",ubicomp:"chi",uist:"chi",icra:"robotics",iros:"robotics",rss:"robotics",
